...
<template>
  ...
  >
    <div class="flex items-center gap-4">
      <!-- <svg class="h-7 w-7 text-primary" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
      ...
      <h1 class="text-xl font-bold text-stone-900 dark:text-white tracking-tight">MechKey</h1>
    </div>
    ...
    <div class="flex items-center gap-2">
      <button
        class="flex items-center justify-center rounded-lg h-10 px-4 bg-stone-100 dark:bg-stone-800/50 hover:bg-stone-200 dark:hover:bg-stone-700/50 text-stone-700 dark:text-stone-200 text-sm font-bold transition-colors"
      >
